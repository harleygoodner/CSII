...
#Discription: This code was created to build an architecture to allow for the analysis of data. The program allows a user to sift through data and answer potential questions/manipulate the data itself by adding or deleting rows in the file.
